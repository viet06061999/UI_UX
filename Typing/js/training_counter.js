const firstDictionary = [['TH','P',''],['V','K',''],['C','S','P'],['S','S','K'],['VỐN ','K','P'],['LÃI ','S','R'],['KHẤU ','R','H'],['NỢ ','P','R'],['CHIẾT ','S','H'],['QUỸ DỰ ','K','P']];
const mainDictionary = [['U','A',''],['Ố','A',''],['H','E','W'],['E','K','R'],['ĐẦU ','A','P'],['TRÁI ','U','R'],['HAO','R','H'],['NGẮN ','P','R'],['KHẤU','S','H'],['TRỮ ','K','P']];
const lastDictionary = [['Ế','T',''],['N','N',''],['I','N','A'],['C','N','I'],['TƯ','N','P'],['PHIẾU','N','R'],[' ','R','H'],['HẠN','P','R'],['','S','H'],['CHUNG','K','P']];
var currentIndex = 0;
