$(document).ready(function () {
    ...
    function countdown() {
        ...
        var timer = setInterval(function () {
            ...
            if (seconds === 0) {
                ...
                pWord.innerHTML = " - Words : " + wordCountTmp;
                topList.appendChild(pWord);
                let pMis = document.createElement("p");
                pMis.innerHTML = " - Mistake : " + mistakeCountTmp;
    ...
    button.addEventListener("click", function (e) {
        ...
        startBtnReal.style.display = "block";
    ...
    startBtnReal.addEventListener("click", function (e) {
        ...
        startBtnReal.style.display = "none";
    ...
    topScoreBtn.addEventListener("click", function (e) {
        menuHome.style.display = "none";
        frameImg.style.display = "block";
        getTopList(topList, scoreList, "points");
        topList.style.display = "block";
        backBtn.style.display = "block";
    });
